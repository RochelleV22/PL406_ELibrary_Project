            ...
            <div class="block">
                ...
                <form action="{{ route('settings.store') }}" id="form-validation" method="post" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label">User extension period (days)</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label">Loan period (days)</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label">Maximum current loan</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label">Number of renewals allowed</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-5 control-label">Activate the user registration page</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-md-6 col-md-offset-5">
                            <button type="submit" class="btn btn-effect-ripple btn-primary" style="overflow: hidden; position: relative;">Save settings</button>
                        </div>
                    </div>
                </form>
