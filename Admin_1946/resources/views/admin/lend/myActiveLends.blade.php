@extends('admin.layouts.master', ['title' => 'امانت های جاری من'])
                                        ...
                                        @elseif($lend->extend_count >= option('maxExtendCount', 1))
                                            <a href="#modal-fade" title="تمدید" data-toggle="modal"
                                               ...
                                               style="overflow: hidden; position: relative;"><i
                                                    class="gi gi-refresh"></i></a>
                                        @else
                                            <a href="{{ route('lends.extendMyLend', ['lend' => $lend->id]) }}"
                                               title="تمدید" class="btn btn-effect-ripple btn-xs btn-primary"
                                               style="overflow: hidden; position: relative;"><i
                                                    class="gi gi-refresh"></i></a>
                                        @endif
                                    </td>
