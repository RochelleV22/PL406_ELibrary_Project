...
class HomeController extends Controller
{
  ...
  //return view('admin.dashboard', compact('users_count', 'books_count', 'active_lends_count', 'comments_count', 'last_articles', 'last_comments'));
        return view('admin.dashboard', compact('users_count', 'books_count', 'comments_count', 'last_articles', 'last_comments'));
    }
...
/*
    public function settingsStore()
    {
        $this->validate(request(), [
            ...
            'user-active-period.required' => 'Please fill these',
            'lend-period.required' => 'Please fill these',
            'max-active-lend.required' => 'Please fill theseد',
            'max-extend-count.required' => 'Please fill these',
        ]);
        ...
        session()->flash('message', 'Please fill these');
