                        ...
                        <div class="container">
                            <div class="row">
                                <div class="blog-page grid">
                                       ...
                                       <article>
                                        <div class="grid-item blog-item" style="height:300px; width:700px;">
                                            
                                            <div class="post-detail">
                                                <header class="entry-header">
                                                    
                                                    <h3 class="entry-title">you can find PDF books here</h3>
                                                </header>
                                                <div class="entry-content" style="height:300px; width:600px;">                     
                                                 <table border="3 solid double;" style="font-size:14px; color:black; " >
                                                           <tr style="padding-top: 12px;
                                                            ...
                                                            <td>{{$data->file}}</td>
                                                                ...
                                                                <td><button style="color:black;"><a href="{{url('/download',$data->file)}}">
                                                                Download</button></td>

                                                                <td><button><a  href="{{url('/book_view',$data->id)}}">View</button></a>
                                                                </td>
                                                                </tr>
                                                            @endforeach
                                                            </table>
