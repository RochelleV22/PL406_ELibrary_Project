    ...
    <body>
       ...
       <!-- Start: Page Banner -->
        ...
        <div id="content" class="site-content">
                               ...
                               <br/>{{$data->name}}
                               <br/>{{$data->description}}
                               <br/><iframe  frameborder="0" scrolling="no" style="height:700px; width:600px"
                               src="{{asset('/files/'.$data->file)}}#toolbar=0"></iframe>
        </div>
        <!-- End: Blog Section -->
  <!-- Start: Footer -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 widget-container">
                            <div id="text-2" class="widget widget_text">
                                <h3 class="footer-widget-title">About E Library</h3>
