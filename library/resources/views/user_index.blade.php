                    ...
                    <div class="col-md-6">
                        <div class="welcome-wrap">
                            <div class="welcome-text">
                                ...
                                <p>An e-Library or Digital Library (both terms often used interchangeably) is a collection of digital objects. These Digital Objects could be classified as text, video, audio, etc.. E Library stores these objects as standardized and customized electronic media formats instead of print, or other media. Most importantly, a electronic library should provide means for organizing, storing, and retrieving the contents. e-Library stores the contents at a central location for providing access on multiple devices</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                            ...
                            <ul>
                                ...
                                <li class="bg-red">
                                    <div class="fact-item">
                                        ...
                                        <span>Magazine<strong class="fact-counter">2</strong></span>
                                    </div>
                                </li>
                                <li class="bg-blue">
                                    <div class="fact-item">
        ...
        <section class="community-testimonial">
            <div class="container">
                <div class="text-center">
                    ...
                    <span class="underline center"></span>
                    <p class="lead">We will be happy to read your feedbacks</p>
                </div>
                    ...
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            ...
                            <div class="user-comment">
                                ...
                                <blockquote cite="#">
                                    Hello ,Good Evening
                                    i Liked your website ,its very useful ,we can use books anywhere also along with pdf books we can find audio and videos also,thank you.
                                </blockquote>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="bottom-portion">
                            <a href="#" class="author">
                                Rahul Sharma <small>(Student)</small>
                            </a>
                    ...
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            ...
                            <div class="user-comment">
                                ...
                                <blockquote cite="#">
                                  Hello Good morning
                                  it was very good website but I had one suggestion I need more books and audios.
                                </blockquote>
                            </div>
                            <div class="clear"></div>
                        </div>
