            ...
            <div class="tab-content">
                ...
                <div class="tab-pane @if($errors->has('delete-category') || $errors->has('replace-category')) active @endif" id="block-tabs-delete">
                    ...
                    <form action="{{ route('book-categories.destroy') }}" id="form-validation1"  method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="delete-category">Select a category to delete<span class="text-danger">*</span></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val-replace-category">Alternative categories<span class="text-danger">*</span></label>
                            <div class="col-md-6">
