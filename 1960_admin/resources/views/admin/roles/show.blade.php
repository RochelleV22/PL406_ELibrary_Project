@extends('admin.layouts.master', ['title' => 'Display Roles'])
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2>Roles information{{ $role->name}}</h2>
                </div>
                ...
                <form id="form-validation" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-md-12 col-md-offset-1">
                            ...
                            <a href="#modal-fade" data-toggle="modal" title="del"><button type="button" class="btn btn-effect-ripple btn-danger" style="overflow: hidden; position: relative;"><i class="fa fa-trash"></i>Delete status</button></a>
                        </div>
                    </div>
                </form>
