...
<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="name" value="{{ __('Name') }}" class="first-letter"/>
                <x-jet-input id="name" class="input-text" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
            </div>

            <div class="mt-4">
                <x-jet-label for="email" value="{{ __('Email') }}" class="first-letter"/>
                <x-jet-input id="email" class="input-text" type="email" name="email" :value="old('email')" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="password" value="{{ __('Password') }}" class="first-letter"/>
                <x-jet-input id="password" class="input-text" type="password" name="password" required autocomplete="new-password" />
            </div>

            <div class="mt-4">
                <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}" class="first-letter"/>
                <x-jet-input id="password_confirmation" class="input-text" type="password" name="password_confirmation" required autocomplete="new-password" />
            </div>
...
<br/>
<br/>
                <x-jet-button class="button btn btn-default">
                    {{ __('Register') }}
                </x-jet-button>
            </div>
        </form>
